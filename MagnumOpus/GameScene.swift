...
class GameScene: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        nameLabelPlayerOne.fontName = "My Font"
        nameLabelPlayerOne.fontSize = 100
        nameLabelPlayerOne.zPosition = 5
        nameLabelPlayerOne.text = playerOneName
        nameLabelPlayerOne.horizontalAlignmentMode = .center
        nameLabelPlayerOne.verticalAlignmentMode = .center
        ...
        nameLabelPlayerTwo.fontName = "My Font"
        nameLabelPlayerTwo.fontSize = 100
        nameLabelPlayerTwo.zPosition = 5
        nameLabelPlayerTwo.text = playerTwoName
        nameLabelPlayerTwo.horizontalAlignmentMode = .center
        nameLabelPlayerTwo.verticalAlignmentMode = .center
